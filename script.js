...
const config = {
    serverInfo: {
        ...
        serverName: "FAGAMA", /*Server name*/
        serverIp: "fagama.aternos.me", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1204870728059719741" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    All skins for original players are generate automaticaly. If you want to add skins to warez players, yout must add url for skin to skinUrlOrPathToFile
        {
            inGameName: "IKFEDO13",  <--- In-Game name
            rank: "Owner",  <-- rank
    ...
    */
    ...
    adminTeamPage: {
        leaders: [
            ...
            {
                inGameName: "jiaan2813",
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Nililator",
                rank: "Manager",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "Lacasitonpro",
                rank: "Moderator",
                skinUrlOrPathToFile: "",
                rankColor: ""
            }
...
const getMinecraftOnlinePlayer = async () => {
    try {
        ...
        const apiUrl = `https://api.mcsrvstat.us/2/${fagama.aternos.me}`;
